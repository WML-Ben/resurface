...
/* validators_en 2017-03-30 */
function isCode(a){return/^[a-zA-Z0-9]{1}[a-zA-Z0-9\-]*[a-zA-Z0-9]{1}$/.test(a)}function isPassword(a,b){"undefined"==typeof b&&(b=6);var c=new RegExp("^.{"+b+",}$");return!/\s+$/.test(a)&&c.test(a)}function isNeedle(a){return isText(a)&&a.length>2}function isText(a){return a=a.replace(/&lt;/g,"<").replace(/&gt;/g,">"),!/(<\/?\s*(javascript|script|onmouseover|onmousedown|onclick)\b.*?>)/i.test(a)}function isRichText(a){return a=a.replace(/&lt;/g,"<").replace(/&gt;/g,">"),!/(<\/?\s*(javascript|script|onmouseover|onmousedown|onclick)\b.*?>)/i.test(a)}function isPlainText(a){return/^[^<>]+$/.test(a)}function isTinyMceText(a){return isText(tinymce.get(a).getContent())}function isSlug(a){return/^[a-z]{1}[a-z\-]*$/.test(a)}function isIdentifier(a){return/^[a-zA-Z_]{1}[a-zA-Z0-9_]*$/.test(a)}function isCustomComboBox(a){return!!$("#"+a).parents(".ui-widget").find(".custom-combobox-input").val()}function isLetter(a){return/^[a-zA-ZáéíóúñÁÉÍÓÚÑ]+$/.test(a)}function isAlpha(a){return/^[a-zA-Z]+$/.test(a)}function isLower(a){return/^[a-z]+$/.test(a)}function isAlphaNumeric(a){return/^[0-9a-zA-Z]+$/.test(a)}function isPositive(a){return/^[1-9]{1}[0-9]*$/.test(a)}function isInteger(a){return/^-?[0-9]+$/.test(a)}function isZeroOrPositive(a){return/^[0-9]+$/.test(a)}function isFloat(a){return/^(\-)?[0-9]+(\.)?([0-9]+)?$/.test(a)}function isZipCode(a){return/^[1-9]{1}[0-9]{4}(\-[0-9]{4})?$/.test(a)}function isPostalCode(a){return/^[0-9a-zA-Z_\s\-]+$/.test(a)}function isPersonName(a){return/^[a-zA-ZáéíóúñÁÉÍÓÚÑ\s\-\'\.]+$/.test(a)}function isPhone(a){return/^[0-9\(\)\-\. ]+$/.test(a)}function isInstagram(a){return/^[a-zA-Z]{1}[0-9a-zA-Z_\-]+$/.test(a)}function isAddress(a){return/^[0-9a-zA-ZáéíóúñÁÉÍÓÚÑ\s_,\-\.#\%]+$/.test(a)}function isLocation(a){return/^[a-zA-ZáéíóúñÁÉÍÓÚÑ\s_,\-]+$/.test(a)}function isTime(a){return/^[0-9]{1,2}:[0-9]{2}(:[0-9]{2})?( (am|pm|AM|PM))?$/.test(a)}function isUrl(a){return/^(ftp|https|http):\/\/(www\.)?[a-zA-Z0-9\-\.]{3,}\.[a-z]{2,3}((\/|\?)[_a-zA-Z0-9#!:\.?+=&%@!\-\/]*)*$/.test(a)}function isRelativeUrl(a){return/^(\/)?[a-zA-Z0-9\-\.\/]+$/.test(a)}function isUrlSegment(a){return/^[a-zA-Z]{1}[a-zA-Z0-9_\-]+$/.test(a)}function isFriendlyUrlSegments(a){return/^[a-zA-Z]{1}[a-zA-Z0-9_\-\/]+$/.test(a)}function isSubdomain(a){return/^[a-zA-Z]{1}[a-zA-Z0-9_\-]+$/.test(a)}function isCustomUrlSegment(a){return/^[a-zA-Z]{1}[a-zA-Z0-9_\-]+$/.test(a)}function isVideoId(a){return/^[a-zA-Z1-9]{1}[a-zA-Z0-9_\-]+$/.test(a)}function isIntPercent(a){return/^(([1-9]{1}[0-9]{0,1})|(100{1}))\s*%{0,1}$/.test(a)}function isISODate(a){return/^[0-9]{2,4}\-(([1-9])|(0[1-9])|(1[0-2]))\-|(([1-9])|(0[1-9])|([1-2][0-9])|(3[0-1]))$/.test(a)}function isUSDate(a){return/^(([1-9])|(0[1-9])|(1[0-2]))\/(([1-9])|([0-2][0-9])|(3[0-1]))\/[0-9]{2,4}$/.test(a)}function isSPDate(a){return/^(([1-9])|(0[1-9])|([1-2][0-9])|(3[0-1]))\-(([1-9])|(0[1-9])|(1[0-2]))\-[0-9]{2,4}$/.test(a)}function isCurrency(a){return/^(0\.)?\d+(\.\d{1,2})?$/.test(a)}function isBoolean(a){return/^(on|off|true|false|1|0)$/.test(a)}function isPhoneNumber(a){return/^[0-9\(\)\[\]\-\.\s\+]+$/.test(a)}function htmlEncode(a){return a.replace(/[\u00A0-\u9999<>\&]/gim,function(a){return"&#"+a.charCodeAt(0)+";"})}function cleanHTML(a){return a.replace(/<([^>]*?)>/g,"")}function isSummernoteEmpty(a){return html=a.code(),html=html.replace(/<([^>]*?)>/g,"").replace(/(&nbsp;|\s)*/g,""),""==html}function getSummernoteText(a){return isSummernoteEmpty(a)?"":a.code()}function setSummernoteValueOnHiddenField(a){var b=a.attr("data-target");$("#"+b).size()||a.append('<input type="hidden" class="summer-note-hidden-input" id="'+b+'" name="'+b+'" value="" />'),$("#"+b).val(getSummernoteText(a))}function alertSummerNotesBeforeSubmit(){$(".summer-note-hidden-input").remove();var b,d,a=[];return $(".summer-note").each(function(){d=getSummernoteText($(this)),$(this).attr("aria-required")&&"required"!=$(this).attr("aria-required")&&"true"!=$(this).attr("aria-required")?""==d||isText(d)?(b=$(this).attr("data-target"),$(this).append('<input type="hidden" class="summer-note-hidden-input" id="'+b+'" name="'+b+'" value="" />'),$("#"+b).val(d)):a.push("<li>"+$(this).attr("data-title")+"</li>"):""!=d&&isText(d)?(b=$(this).attr("data-target"),$(this).append('<input type="hidden" class="summer-note-hidden-input" id="'+b+'" name="'+b+'" value="" />'),$("#"+b).val(d)):a.push("<li>"+$(this).attr("data-title")+"</li>")}),a.length>0?($(".summer-note-hidden-input").remove(),{success:!1,message:"Invalid and/or missing text on fields:<br><ul>"+a.join(" ")+"<ul>"}):{success:!0}}function validateSummerNotesBeforeSubmit(a){form="FORM"==a.prop("tagName")?a:a.parents("form"),form.find(".summer-note-hidden-input").remove(),form.find("em.state-error").remove(),form.find(".state-error").removeClass("state-error");var b=!0;return form.find(".summer-note").each(function(){validateSummernote($(this))||(b=!1)}),b}function validateSummernote(a){var c,b=a.parents(".summernote-container"),e=!1,f=getSummernoteText(a);return a.attr("aria-required")&&"required"!=a.attr("aria-required")&&"true"!=a.attr("aria-required")?""==f||isText(f)?(c=a.attr("data-target"),a.append('<input type="hidden" class="summer-note-hidden-input" id="'+c+'" name="'+c+'" value="" />'),$("#"+c).val(f),e=!0):(e=!1,b.addClass("state-error"),b.find(".note-editor").after('<em class="state-error" id="'+a.attr("data-target")+'-error">Invalid text.</em>')):""!=f&&isText(f)?(c=a.attr("data-target"),a.append('<input type="hidden" class="summer-note-hidden-input" id="'+c+'" name="'+c+'" value="" />'),$("#"+c).val(f),e=!0):(e=!1,b.addClass("state-error"),""==f?b.after('<em class="state-error" id="'+a.attr("data-target")+'">This field is required.</em>'):b.after('<em class="state-error" id="'+a.attr("data-target")+'">Invalid text.</em>')),e}function validateMultiComboBoxBeforeSubmit(a){form="FORM"==a.prop("tagName")?a:a.parents("form"),form.find("em.state-error").remove(),form.find(".state-error").removeClass("state-error");var b=!0;return form.find(".multi-combobox").each(function(){var a=$(this).parents(".multi-combobox-container");$(this).val()||$(this).attr("aria-required")&&"required"!=$(this).attr("aria-required")&&"true"!=$(this).attr("aria-required")||(b=!1,a.addClass("state-error"),a.find("button.multiselect").after('<em class="state-error" id="'+$(this).attr("id")+'">This field is required.</em>'))}),b}function validateMceBeforeSubmit(a){var c=("FORM"==a.prop("tagName")?a:a.parents("form"),tinymce.editors),d=!0;return $.each(c,function(a,b){var c=$("#"+b.id).parents(".mce-wrapper"),f=(c.find(".mce-tinymce.mce-container.mce-panel"),$("#"+b.id)),g=b.getContent();c.removeClass("state-error").removeClass("error-empty").removeClass("error-invalid"),f.data("required")&&""==g?(d=!1,c.removeClass("error-invalid").addClass("state-error error-empty")):isText(g)||(d=!1,c.removeClass("error-empty").addClass("state-error error-invalid"))}),d}function isEmail(a){return/^[a-zA-Z0-9_\.\-]+@([a-zA-Z0-9\-]+\.)+[a-zA-Z]+$/.test(a)}$(function(){$.validator.addMethod("code",function(a,b){return this.optional(b)||isCode(a)},"Invalid code"),$.validator.addMethod("address",function(a,b){return this.optional(b)||isAddress(a)},"Invalid address"),$.validator.addMethod("city",function(a,b){return this.optional(b)||isLocation(a)},"Invalid city"),$.validator.addMethod("state",function(a,b){return this.optional(b)||isLocation(a)},"Invalid state"),$.validator.addMethod("location",function(a,b){return this.optional(b)||isLocation(a)},"Invalid location"),$.validator.addMethod("postalCode",function(a,b){return this.optional(b)||isPostalCode(a)},"Invalid postal code"),$.validator.addMethod("float",function(a,b){return this.optional(b)||isFloat(a)},"Invalid entry."),$.validator.addMethod("needle",function(a,b){return this.optional(b)||isNeedle(a)},"Invalid entry."),$.validator.addMethod("smartCaptcha",function(a,b,c){return a==c},"Incorrect verification code."),$.validator.addMethod("text",function(a,b){return this.optional(b)||isText(a)},"Invalid text."),$.validator.addMethod("plainText",function(a,b){return this.optional(b)||isPlainText(a)},"This field cannot contain html tags."),$.validator.addMethod("mceText",function(a,b){return this.optional(b)||isTinyMceText(b)},"Invalid text."),$.validator.addMethod("lower",function(a,b){return this.optional(b)||isLower(a)},"Only lowercase letters are allowed."),$.validator.addMethod("letter",function(a,b){return this.optional(b)||isLetter(a)},"Only letters are allowed."),$.validator.addMethod("slug",function(a,b){return this.optional(b)||isSlug(a)},"Only lowercase letters and dash are allowed."),$.validator.addMethod("identifier",function(a,b){return this.optional(b)||isIdentifier(a)},"Only letters, numbers and underscore are allowed."),$.validator.addMethod("personName",function(a,b){return this.optional(b)||isPersonName(a)},"Invalid person name."),$.validator.addMethod("firstName",function(a,b){return this.optional(b)||isPersonName(a)},"Invalid first name."),$.validator.addMethod("lastName",function(a,b){return this.optional(b)||isPersonName(a)},"Invalid last name."),$.validator.addMethod("fullUrl",function(a,b){return this.optional(b)||isUrl(a)},"Invalid url."),$.validator.addMethod("relativeUrl",function(a,b){return this.optional(b)||isRelativeUrl(a)},"Invalid relative url."),$.validator.addMethod("friendlyUrlSegments",function(a,b){return this.optional(b)||isFriendlyUrlSegments(a)},"Invalid url."),$.validator.addMethod("urlSegment",function(a,b){return this.optional(b)||isUrlSegment(a)},"Invalid url segment."),$.validator.addMethod("subdomain",function(a,b){return this.optional(b)||isSubdomain(a)},"Invalid subdomain."),$.validator.addMethod("customUrlSegment",function(a,b){return this.optional(b)||isCustomUrlSegment(a)},"Invalid custom url segment."),$.validator.addMethod("videoId",function(a,b){return this.optional(b)||isVideoId(a)},"Invalid video id."),$.validator.addMethod("positive",function(a,b){return this.optional(b)||isPositive(a)},"This is not a positive number."),$.validator.addMethod("zeroOrPositive",function(a,b){return this.optional(b)||isZeroOrPositive(a)},"This is not zero or a positive number."),$.validator.addMethod("password",function(a,b){return this.optional(b)||isPassword(a)},"Invalid entry."),$.validator.addMethod("isoDate",function(a,b){return this.optional(b)||isISODate(a)},"Valid format is Y-m-d"),$.validator.addMethod("usDate",function(a,b){return this.optional(b)||isUSDate(a)},"Valid format is m/d/Y"),$.validator.addMethod("spDate",function(a,b){return this.optional(b)||isSPDate(a)},"Valid format is d-m-Y"),$.validator.addMethod("currency",function(a,b){return this.optional(b)||isCurrency(a)},"Invalid currency value"),$.validator.addMethod("boolean",function(a,b){return this.optional(b)||isBoolean(a)},"Invalid boolean value"),$.validator.addMethod("phone",function(a,b){return this.optional(b)||isPhoneNumber(a)},"Invalid phone number")});
/* jquery.validate */
