<div class="panel-body">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 admin-form-item-widget">
            {{ Form::jSelect('category_id', $companyCategoriesCB, ['label' => 'Category', 'selected' => $company->category_id ?? null, 'required' => true, 'iconClass' => 'fa fa-bars', 'attributes' => ['id' => 'category_id']]) }}
        </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 admin-form-item-widget">
            {{ Form::jSelect('country_id', $countriesCB, ['label' => 'Country', 'selected' => $company->country_id ?? 231, 'required' => true, 'iconClass' => 'fa fa-globe', 'attributes' => ['id' => 'country_id']]) }}
        </div>
        <div class="col-xs-12 col-sm-6 admin-form-item-widget">
            {{ Form::jSelect('state_id', $statesCB, ['label' => 'State', 'selected' => $company->state_id ?? 3930, 'required' => true, 'iconClass' => 'fa fa-map-pin', 'attributes' => ['id' => 'state_id']]) }}
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12 admin-form-item-widget">
            {{ Form::jSwitch('above_as_billing_address', ['label' => 'Use above as Billing Address', 'id' => 'above_as_billing_address', 'checked' => empty($company)]) }}
        </div>
    </div>
    <div id="billing_container">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 admin-form-item-widget">
                {{ Form::jSelect('billing_country_id', $countriesCB, ['label' => 'Billing Country', 'selected' => $company->billing_country_id ?? 231, 'required' => false, 'iconClass' => 'fa fa-globe', 'attributes' => ['id' => 'billing_country_id']]) }}
            </div>
            <div class="col-xs-12 col-sm-6 admin-form-item-widget">
                {{ Form::jSelect('billing_state_id', $statesCB, ['label' => 'Billing State', 'selected' => $company->billing_state_id ?? 3930, 'required' => false, 'iconClass' => 'fa fa-map-pin', 'attributes' => ['id' => 'billing_state_id']]) }}
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-6 admin-form-item-widget">
            {{ Form::jSwitch('qualified', ['label' => 'Qualified', 'id' => 'qualified', 'checked' => !empty($company->qualified)]) }}
        </div>
        <div class="col-sm-6 admin-form-item-widget">
            {{ Form::jSwitch('disabled', ['label' => 'Disabled', 'id' => 'disabled', 'checked' => !empty($company->disabled)]) }}
        </div>
    </div>
</div>
