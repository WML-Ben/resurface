...
@section('breadcrumbs')
    <div class="mb15">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="{{ route('appointment_list') }}">Appointments</a><i class="fa fa-angle-right"></i></li>
        ...
        <div class="row">
            <div class="col-md-9 center-block">
                ...
                <div class="admin-form theme-primary">
                    <div class="panel">
                        {!! Form::model($appointment, ['url' => route('appointment_update', ['id' => $appointment->id]), 'method' => 'PATCH', 'id' => 'updateForm']) !!}
                            {!! Form::hidden('id', $appointment->id) !!}
                            @include('appointment._form', ['formTitle' => 'Update Appointment', 'submitButtonText' => 'Update'])
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
...
@section('js-files')
    <script>
        $(function(){
            ...
            $('#appointment_id').change(function(ev){
                $.ajax({
                    type:"post",
                    url: "{{ route('ajax_appointment_managers_fetch') }}",
                    data: {
            ...
            $('#cancel-button').click(function(ev){
                ev.preventDefault();
                window.location = "{{ route('appointment_list') }}";
            });
        });
    </script>
@stop