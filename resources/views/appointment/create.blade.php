        ...
        <div class="row">
            <div class="col-md-9 center-block">
                ...
                <div class="admin-form theme-primary">
                    <div class="panel">
                        {!! Form::open(['url' => route('appointment_store'), 'id' => 'createForm']) !!}
                            @include('appointment._form', ['formTitle' => 'New Appointment', 'submitButtonText' => 'Create Appointment', 'create' => true])
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
