                                    ...
                                    <div class="portlet blue-hoki box">
                                        ...
                                        <div class="portlet-body">
                                            ...
                                            <div class="row" id="required_fields_section">
                                                ...
                                                <div class="col-md-4 col-sm-4 admin-form-item-widget bk-light-blue">
                                            ...
                                            <div class="row pb20">
                                                <div class="col-md-12 admin-form-item-widget">
                                                    {{ Form::jTextarea('description', ['label' => 'Description', 'id' => 'description', 'required' => true, 'iconClass' => 'fa fa-bookmark']) }}
                                                </div>
                                            </div>
