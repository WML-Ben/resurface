                            ...
                            <tr data-id="{{ $subContractor->id }}">
                                <td class="td-checkbox tt">
                                    <div class="radio-checkbox-container vertical">
                                        <label for="sub_contractor_id_{{ $subContractor->id }}" class="radio-checkbox-item">
                                            <input id="sub_contractor_id_{{ $subContractor->id }}" class="checkbox" type="checkbox" value="{{ $subContractor->id }}">
                                            <i class="fa fa-square-o"></i>
                                            <i class="fa fa-check-square-o"></i>
                                        </label>
                                    </div>
                                ...
                                <td class="">
                                    <label for="sub_contractor_description_{{ $subContractor->id }}" class="field">
                                        <textarea class="gui-input gui-textarea description tl" id="sub_contractor_description_{{ $subContractor->id }}" name="sub_contractor_description[]"></textarea>
                                    </label>
                                </td>
                                ...
                                <td class="td-number tt">
                                    <label for="sub_contractor_quoted_cost_{{ $subContractor->id }}" class="field">
                                        <input class="gui-input quoted_cost tc" id="sub_contractor_quoted_cost_{{ $subContractor->id }}" name="sub_contractor_quoted_cost[]" type="text">
                                    </label>
                                </td>
                                <td class="tt tc">
                                    <div class="radio-checkbox-container vertical">
