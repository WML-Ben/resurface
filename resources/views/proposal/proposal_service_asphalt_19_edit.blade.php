                                    ...
                                    <div class="portlet blue-hoki box">
                                        ...
                                        <div class="portlet-body">
                                            ...
                                            <div id="required_fields_section">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3 admin-form-item-widget">
                                                        {{ Form::jText('days', ['label' => 'Days of Milling', 'id' => 'days', 'required' => true, 'iconClass' => 'fa fa-hashtag']) }}
                                                    </div>
                                                    <div class="col-sm-3 admin-form-item-widget">
                                                        {{ Form::jText('cost_per_day', ['label' => 'Cost per Day', 'id' => 'cost_per_day', 'required' => true, 'iconClass' => 'fa fa-dollar']) }}
                                                    </div>
                                                    <div class="col-sm-3 admin-form-item-widget">
                                                        {{ Form::jShow($service->square_yards ?? '&nbsp;', ['label' => 'Square Yards', 'id' => 'show_square_yards', 'class' => 'icon-class-container', 'iconClass' => 'fa fa-hashtag']) }}
                                                    </div>
                                                    <div class="col-sm-3 admin-form-item-widget">
...
@section('js-files')
    <script>
        ...
        function calculateAll()
        {
            ...
            var days = normalizeFloat($('#days').val());
            var costPerDay = normalizeFloat($('#cost_per_day').val());
            var squareFeet = normalizeFloat($('#square_feet').val());
            var unit = squareFeet;

            // hidden_square_yards hidden_square_loads    square_feet depth_in_inches locations days cost_per_day
            ...
            var loads = Math.ceil(squareFeet * depthInInches * 7 / 2160);

            $('#show_loads').html(loads);
            $('#hidden_loads').val(loads);

            var materialsTotalCost = costPerDay * days;
            ...
            var overhead = (otCost / 0.88) - otCost;
