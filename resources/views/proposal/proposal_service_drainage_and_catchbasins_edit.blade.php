                                    ...
                                    <div class="portlet blue-hoki box">
                                        ...
                                        <div class="portlet-body">
                                            ...
                                            <div class="row" id="required_fields_section">
                                                ...
                                                <div class="col-sm-4 admin-form-item-widget bk-light-blue">
                                                    {{ Form::jText('additive', ['label' => 'Number of Catch Basins', 'id' => 'additive', 'required' => true, 'iconClass' => 'fa fa-hashtag']) }}
                                                </div>
                                                <div class="col-sm-4 admin-form-item-widget">
