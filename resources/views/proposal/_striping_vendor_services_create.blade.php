        ...
        <div class="portlet-body">
                                    ...
                                    <tr data-id="{{ $stripingService->id }}" data-price="{{ $stripingService->stripingVendors->first()->price }}">
                                        <td class="td-checkbox">
                                            <div class="radio-checkbox-container vertical">
                                                <label for="striping_service_id_{{ $stripingService->id }}" class="radio-checkbox-item">
                                                    <input id="striping_service_id_{{ $stripingService->id }}" class="checkbox" type="checkbox" value="{{ $stripingService->id }}">
                                                    <i class="fa fa-square-o"></i>
                                                    <i class="fa fa-check-square-o"></i>
                                                </label>
                                            </div>
                                        ...
                                        <td class="td-number">
                                            <label for="striping_service_quantity_{{ $stripingService->id }}" class="field">
                                                <input class="gui-input quantity tc" id="striping_service_quantity_{{ $stripingService->id }}" name="striping_service_quantity[]" type="text">
                                            </label>
                                        </td>
                                    </tr>
                                @endforeach
            ...
            <div class="row">
                ...
                <div class="col-sm-6 tr">
                    Total Services Cost: <strong>$<span id="section_striping_service_total_cost" class="section-total-cost">0.00</span></strong>
                </div>
            </div>
        </div>
    </div>
