                        ...
                        <tr data-id="{{ $otherCostCategory->id }}">
                            <td class="td-checkbox tt">
                                <div class="radio-checkbox-container vertical">
                                    <label for="other_cost_category_id_{{ $otherCostCategory->id }}" class="radio-checkbox-item">
                                        <input id="other_cost_category_id_{{ $otherCostCategory->id }}" class="checkbox" type="checkbox" value="{{ $otherCostCategory->id }}">
                                        <i class="fa fa-square-o"></i>
                                        <i class="fa fa-check-square-o"></i>
                                    </label>
                                </div>
                            ...
                            <td class="">
                                <label for="other_cost_category_description_{{ $otherCostCategory->id }}" class="field">
                                    <textarea class="gui-input gui-textarea description tl" id="other_cost_category_description_{{ $otherCostCategory->id }}" name="other_cost_category_description[]"></textarea>
                                </label>
                            </td>
                            <td class="td-number tt">
                                <label for="other_cost_category_cost_{{ $otherCostCategory->id }}" class="field">
                                    <input class="gui-input cost tc" id="other_cost_category_cost_{{ $otherCostCategory->id }}" name="other_cost_category_cost[]" type="text">
                                </label>
                            </td>
                        </tr>
                    @endforeach
