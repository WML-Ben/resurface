                                    ...
                                    <div class="portlet blue-hoki box">
                                        ...
                                        <div class="portlet-body">
                                            ...
                                            <div class="row" id="required_fields_section">
                                                <div class="col-md-3 col-sm-6 admin-form-item-widget">
                                                    {{ Form::jText('profit', ['label' => 'Profit', 'id' => 'profit', 'required' => true, 'iconClass' => 'fa fa-dollar']) }}
                                                </div>
                                                <div class="col-md-3 col-sm-6 admin-form-item-widget bk-light-blue">
                                                ...
                                                <div class="col-md-3 col-sm-6 admin-form-item-widget">
                                                    {{ Form::jText('tons', ['label' => 'Excavate Tons', 'id' => 'tons', 'required' => true, 'iconClass' => 'fa fa-hashtag']) }}
                                                </div>
                                            </div>
                                            <div class="row pb20">
...
@section('js-files')
    <script>
        ...
        function calculateAll()
        {
            ...
            var overhead = (otCost / 0.75) - otCost;
