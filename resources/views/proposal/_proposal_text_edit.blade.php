    ...
    <div class="portlet-body">
        <div class="row">
            <div class="col-xs-12 col-sm-6 admin-form-item-widget" id="show_proposal_text_container">
                {{ Form::jShow($obj->proposal_text ?? '&nbsp;', ['label' => 'Suggested Proposal Text', 'id' => 'show_proposal_text']) }}
            </div>
            <div class="col-xs-12 col-sm-6 admin-form-item-widget">
                {!! Form::jMce('proposal_text', ['required' => false, 'id' => 'proposal_text', 'label' => 'Actual Proposal Text', 'value' => $obj->proposal_text ?? '' ]) !!}
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
