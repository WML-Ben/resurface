                                        ...
                                        <div class="portlet-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div id="total_overhead_container" class="col-sm-20 col-xs-3 admin-form-item-widget">
                                                    {{ Form::jShow('&nbsp;', ['label' => 'Over Head', 'hint' => '(calculated at '. ($service->id == 4 || $service->id == 22 ? '20%' : '30%') .')', 'id' => 'show_overhead', 'iconClass' => 'fa fa-dollar', 'class' => 'icon-class-container']) }}
                                                </div>
                                                <div class="col-sm-20 col-xs-3 admin-form-item-widget">
...
@section('js-files')
    <script>
        ...
        function calculateAll()
        {
            ...
            var serviceId = normalizeInteger("{{ $service->id }}");
            var tacks;
