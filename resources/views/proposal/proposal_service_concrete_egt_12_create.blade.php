                                        ...
                                        <div class="portlet-body">
                                            ...
                                            <div id="required_fields_section">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2 admin-form-item-widget">
                                                        {{ Form::jShow($concreteMaterials[9]->cost_currency ?? '&nbsp;', ['label' => 'Drum Mix Cost', 'id' => 'show_cost_per_cubic_yards', 'class' => 'icon-class-container', 'iconClass' => 'fa fa-hashtag']) }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row pb20">
...
@section('js-files')
    <script>
        ...
        function calculateAll()
        {
            ...
            var mixCost = normalizeFloat("{{ $concreteMaterials[10]->cost ?? 0 }}");
            var cubicYards = squareFeet * depthInInches / 300;

            $('#show_cubic_yards').html(formatMoney(cubicYards));
            $('#hidden_cubic_yards').val(cubicYards);

            var materialsTotalCost = cubicYards * mixCost;
