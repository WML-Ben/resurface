                        ...
                        <div class="stat-panel">
                            <div class="stat-row">
                                ...
                                {!!Form::open(['url' => route('proposal_details_service_store', ['proposal_id' => $proposal->id]), 'id' => 'serviceForm']) !!}
                                    ...
                                    {!! Form::hidden('cubic_yards', null, ['id' => 'hidden_cubic_yards']) !!}
                                    {!! Form::hidden('unit_cost', null, ['id' => 'hidden_unit_cost']) !!}
                                    ...
                                    <div class="portlet blue-hoki box">
                                        ...
                                        <div class="portlet-body">
                                            ...
                                            <div id="required_fields_section">
                                                <div class="row">
                                                    <div class="col-sm-20 admin-form-item-widget">
                                                        {{ Form::jText('profit', ['label' => 'Profit', 'id' => 'profit', 'required' => true, 'iconClass' => 'fa fa-dollar']) }}
                                                    </div>
                                                    <div class="col-sm-20 admin-form-item-widget">
                                                        {{ Form::jText('linear_feet', ['label' => 'Linear Feet', 'id' => 'linear_feet', 'required' => true, 'iconClass' => 'fa fa-hashtag']) }}
                                                    </div>
                                                    <div class="col-sm-20 admin-form-item-widget">
                                                        {{ Form::jText('locations', ['label' => 'Locations', 'id' => 'locations', 'required' => true, 'iconClass' => 'fa fa-hashtag']) }}
                                                    </div>
                                                    <div class="col-sm-20 admin-form-item-widget">
                                                        {{ Form::jShow($service->cubic_yards ?? '&nbsp;', ['label' => 'Cubic Yards', 'id' => 'show_cubic_yards', 'class' => 'icon-class-container', 'iconClass' => 'fa fa-hashtag']) }}
                                                    </div>
                                                    <div class="col-sm-20 admin-form-item-widget">
                                                        {{ Form::jShow($concreteMaterials[9]->cost_currency ?? '&nbsp;', ['label' => 'Curb Mix Cost', 'id' => 'show_cost_per_cubic_yards', 'class' => 'icon-class-container', 'iconClass' => 'fa fa-hashtag']) }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row pb20">
...
@section('js-files')
    <script>
        ...
        {
            // set hidden fields on general from this form fields:     linear_feet locations

            var profit = normalizeFloat($('#profit').val());
            var linearFeet = normalizeFloat($('#linear_feet').val());
            var unit = linearFeet;

            // do calculation on first block:

            var curbCost = normalizeFloat("{{ $concreteMaterials[9]->cost ?? 0 }}");
            ...
            switch (serviceId) {
                case '6':
                default:
                    cubicYards = linearFeet / 60;
                    break;
                case '7':
                    cubicYards = linearFeet / 21;
                    break;
                case '8':
                    cubicYards = linearFeet / 30;
                    break;
                case '9':
                    cubicYards = linearFeet / 24;
                    break;
                case '10':
                    cubicYards = linearFeet / 15;
                    break;
                case '11':
                    cubicYards = linearFeet / 25;
                    break;
            }

            $('#hidden_cubic_yards').val(cubicYards);

            $('#show_cubic_yards').html(formatMoney(cubicYards));

            var materialsTotalCost = cubicYards * curbCost;
