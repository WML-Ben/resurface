                    ...
                    <table class="table table-bordered list-table sortable-table">
                        ...
                        <tbody class="multi-section">
                            ...
                            @foreach ($obj as $vehicleType)
                                @php
                                    $existingObj = $orderService->vehicleTypes()->where('vehicle_type_id', $vehicleType->id)->first();
                                @endphp
                                <tr data-id="{{ $vehicleType->id }}" data-rate="{{ $vehicleType->rate }}">
                                    <td class="td-checkbox">
                                        <div class="radio-checkbox-container vertical">
                                            <label for="vehicle_type_id_{{ $vehicleType->id }}" class="radio-checkbox-item">
                                                <input id="vehicle_type_id_{{ $vehicleType->id }}" class="checkbox" type="checkbox" value="{{ $vehicleType->id }}"{{ !empty($existingObj->id) ? ' checked' : '' }}>
                                                <i class="fa fa-square-o"></i>
                                                <i class="fa fa-check-square-o"></i>
                                            </label>
                                        </div>
                                    ...
                                    <td class="td-number">
                                        <label for="vehicle_type_quantity_{{ $vehicleType->id }}" class="field">
                                            <input class="gui-input quantity tc" id="vehicle_type_quantity_{{ $vehicleType->id }}" name="vehicle_type_quantity[]" type="text" value="{{ $existingObj->quantity ?? '' }}">
                                        </label>
                                    </td>
                                    <td class="td-number">
                                        <label for="vehicle_type_days_needed_{{ $vehicleType->id }}" class="field">
                                            <input class="gui-input days-needed tc" id="vehicle_type_days_needed_{{ $vehicleType->id }}" name="vehicle_type_days_needed[]" type="text" value="{{ $existingObj->days_needed ?? '' }}">
                                        </label>
                                    </td>
                                    <td class="td-number">
                                        <label for="vehicle_type_hours_per_day_{{ $vehicleType->id }}" class="field">
                                            <input class="gui-input hours-per-day tc" id="vehicle_type_hours_per_day_{{ $vehicleType->id }}" name="vehicle_type_hours_per_day[]" type="text" value="{{ $existingObj->hours_per_day ?? '' }}">
                                        </label>
                                    </td>
                                </tr>
                            @endforeach
