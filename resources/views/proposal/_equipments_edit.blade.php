                    ...
                    <table class="table table-bordered list-table sortable-table">
                        ...
                        <tbody class="multi-section">
                            @foreach ($obj as $equipment)
                                @php
                                    $existingEquipment = $orderService->equipments()->where('equipment_id', $equipment->id)->first();
                                @endphp
                                <tr data-id="{{ $equipment->id }}" data-cost="{{ $equipment->cost }}" data-min_cost="{{ $equipment->min_cost }}" data-rate_type_id="{{ $equipment->rate_type_id }}">
                                    <td class="td-checkbox">
                                        <div class="radio-checkbox-container vertical">
                                            <label for="equipment_id_{{ $equipment->id }}"  class="radio-checkbox-item">
                                                <input id="equipment_id_{{ $equipment->id }}" class="checkbox" type="checkbox" value="{{ $equipment->id }}"{{ !empty($existingEquipment->id) ? ' checked' : '' }}>
                                                <i class="fa fa-square-o"></i>
                                                <i class="fa fa-check-square-o"></i>
                                            </label>
                                        </div>
                                    ...
                                    <td class="td-currency">{{ $equipment->tons }} {{ $equipment->rateType->name }}</td>
                                    <td class="td-number">
                                        <label for="equipment_quantity_{{ $equipment->id }}" class="field">
                                            <input class="gui-input quantity tc" id="equipment_quantity_{{ $equipment->id }}" name="equipment_quantity[]" type="text" value="{{ $existingEquipment->quantity ?? '' }}">
                                        </label>
                                    </td>
                                    <td class="td-number">
                                        <label for="equipment_days_needed_{{ $equipment->id }}" class="field">
                                            <input class="gui-input days-needed tc" id="equipment_days_needed_{{ $equipment->id }}" name="equipment_days_needed[]" type="text" value="{{ $existingEquipment->days_needed ?? '' }}">
                                        </label>
                                    </td>
                                    <td class="td-number">
                                        <label for="equipment_hours_per_day_{{ $equipment->id }}" class="field">
                                            ...
                                            @else
                                                <input class="gui-input hours-per-day tc" id="equipment_hours_per_day_{{ $equipment->id }}" name="equipment_hours_per_day[]" type="text" required="true" value="{{ $existingEquipment->hours_per_day ?? '' }}">
                                            @endif
                                        </label>
                                    </td>
