                                            ...
                                            <div id="required_fields_section">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 admin-form-item-widget">
                                                        <div class="radio-checkbox-container horizontal">
                                                            @foreach ($rockMaterials as $rockMaterial)
                                                                <label class="radio-checkbox-item radio-item">
                                                                    <input type="radio" name="additive" value="{{ $rockMaterial->cost }}" {!! (empty($service->additive) && $loop->first) || ($service->additive == $rockMaterial->cost) ? 'checked' : '' !!}>
                                                                    <i class="fa fa-circle-o"></i>
                                                                    <i class="fa fa-dot-circle-o"></i>
                                                                    <span>{{ $rockMaterial->name }} - {{ $rockMaterial->cost_currency }}</span>
                                                                </label>
                                                            @endforeach
                                                        </div>
                                                    </div>
...
@section('js-files')
    <script>
        ...
        function calculateAll()
        {
            ...
            var rockCost = normalizeFloat($('#required_fields_section').find('.radio-item input:radio:checked').val());

            var materialsTotalCost = tons * rockCost;
