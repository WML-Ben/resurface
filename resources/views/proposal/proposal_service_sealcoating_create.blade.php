...
@section('js-files')
    <script>
        ...
        function calculateAll()
        {
            ...
            $('#td_sealer_total_cost').html('$' + sealerformatMoney(totalCost));
            $('#td_sand_total_cost').html('$' + sandformatMoney(totalCost));
            $('#td_additive_total_cost').html('$' + additiveformatMoney(totalCost));
            $('#td_primer_total_cost').html('$' + primerformatMoney(totalCost));
            $('#td_fastset_total_cost').html('$' + fastSetformatMoney(totalCost));
