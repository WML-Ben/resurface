...
<label class="field select">
    {!! Form::select($name, [], !empty($params['selected']) ? $params['selected'] : null, array_merge( ['class' => 'grayed'.(!empty($params['class']) ? ' '.$params['class'] : '')], !empty($params['attributes']) ? $params['attributes'] : [])) !!}
